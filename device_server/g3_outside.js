...
// 树莓派只有一个串口,默认被用来做console,需要先禁用
var SERIAL_PORT = '/dev/ttyAMA0';
// G3的数据包长度为24字节
var PACKAGE_LEN = 24;

// DS18B20 -> GPIO7
var TEMP_SENSOR_PATH = '/sys/bus/w1/devices/28-0000077c73f2/w1_slave';
...
var client_function = function() {
    client = net.connect({port: 8124, host: '192.168.2.100'}, function() { //'connect' listener
        console.log('connected to server[192.168.2.100:8124]');
    });
